...
public class GetAirQuality extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			/*
			 * while (rs.next()) { if ("AC67B25CCCD6".equals(rs.getString("serialNum")) ||
			 * "246F283C7E16".equals(rs.getString("serialNum"))) { // out.println(new
			 * JsonTransfer().transferDom2JSON(_doc).toString()); System.out.println(new
			 * JsonTransfer().transferDom2JSON(_doc).toString()); } }
			 */
