...
public class GetAirQualityForChart extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
			doc = remote.executeQuery(dataSource, QUERY_FILE, "queryBySelectDateForChart", dummy , arr);
